    ...
    <div className="bg-background min-h-screen pt-[72px] pb-24">
      <div className="max-w-[800px] mx-auto px-6 lg:px-8 py-12">
        <div className="text-center mb-8 animate-fade-in-up">
          ...
          <h1 className="heading-display text-2xl md:text-4xl text-foreground mb-4">
            Booking Confirmed!
          </h1>
        ...
        <div className="bg-surface border border-border rounded-2xl overflow-hidden mb-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
          {/* Header Image Split */}
