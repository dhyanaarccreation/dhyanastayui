    ...
    <div className="pb-24">
      ...
      <section className="bg-background py-14 border-b border-border">
        <div className="container-page text-center">
          ...
          <h1 className="heading-display text-3xl md:text-4xl text-foreground mb-6 max-w-3xl mx-auto">
      ...
      <section className="py-14 container-page">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {services.map((svc) => (
            <div key={svc.id} className="bg-surface border border-border rounded-2xl p-6 hover:border-primary/50 transition-colors group cursor-pointer flex flex-col">
      ...
      <section className="container-page">
        <div className="bg-gradient-to-r from-red-950/40 to-surface border border-red-500/20 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <div className="flex items-center gap-2 text-red-400 font-semibold mb-4">
              <ShieldAlert size={20} /> Emegency Assistance
            </div>
            <h2 className="text-xl font-bold text-foreground mb-2">Dhyana SOS Network</h2>
