  ...
  return (
    <section className="py-8 md:py-10 bg-background">
      <div className="container-page">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-3 sm:mb-6 lg:mb-8">
          <div>
        ...
        {visible.length > 0 ? (
          <>
            <div className="relative">
              <div
                className={`flex overflow-x-auto overscroll-x-contain snap-x snap-mandatory scroll-smooth scrollbar-hide gap-2.5 sm:gap-4 -mx-[4.3478%] px-[4.3478%] pb-1 sm:grid sm:grid-cols-2 sm:mx-0 sm:px-0 sm:pb-0 sm:overflow-visible sm:snap-none stagger-children ${
              ...
              >
                {featured.map((dest, i) => (
                  <ImageCard
                    ...
                    titleLayout="row"
                    size="fill"
                    className={`shrink-0 w-[78%] snap-start sm:w-auto sm:shrink ${
            ...
            {rest.length > 0 && (
              <div className="relative mt-2.5 sm:mt-4">
                <div className="flex overflow-x-auto overscroll-x-contain snap-x snap-mandatory scroll-smooth scrollbar-hide gap-2.5 sm:gap-4 -mx-[4.3478%] px-[4.3478%] sm:mx-0 sm:px-0 pb-1">
                  {rest.map((dest) => (
                    <ImageCard
                      key={dest.name}
                      href="/#explore-stays"
